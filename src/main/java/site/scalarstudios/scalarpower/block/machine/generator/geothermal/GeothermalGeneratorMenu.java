...
public class GeothermalGeneratorMenu extends AbstractContainerMenu {
    ...
    public GeothermalGeneratorMenu(int id, Inventory inventory, FriendlyByteBuf buf) {
        this(id, inventory,
                (GeothermalGeneratorBlockEntity) inventory.player.level().getBlockEntity(buf.readBlockPos()),
                new SimpleContainerData(5));
    }

    public GeothermalGeneratorMenu(int id, Inventory inventory, GeothermalGeneratorBlockEntity blockEntity,
            ContainerData data) {
        super(ScalarPowerMenus.GEOTHERMAL_GENERATOR_MENU.get(), id);
