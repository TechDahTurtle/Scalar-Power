...
public class PoweredSwordItem extends Item {
    public PoweredSwordItem(Properties properties) {
        super(properties.fireResistant().sword(ScalarPowerToolMaterials.COBALT, 3.0F, -2.4F));
    }
